...
/**
* @see \App\Http\Controllers\Secretaria\UserController::index
 * @see app/Http/Controllers/Secretaria/UserController.php:22
 * @route '/secretaria/users'
 */
...
/**
* @see \App\Http\Controllers\Secretaria\UserController::create
 * @see app/Http/Controllers/Secretaria/UserController.php:50
 * @route '/secretaria/users/create'
 */
...
/**
* @see \App\Http\Controllers\Secretaria\UserController::store
 * @see app/Http/Controllers/Secretaria/UserController.php:64
 * @route '/secretaria/users'
 */
...
/**
* @see \App\Http\Controllers\Secretaria\UserController::show
 * @see app/Http/Controllers/Secretaria/UserController.php:0
 * @route '/secretaria/users/{user}'
 */
 ...
 */
    ...
    show.form = showForm
/**
* @see \App\Http\Controllers\Secretaria\UserController::edit
 * @see app/Http/Controllers/Secretaria/UserController.php:108
 * @route '/secretaria/users/{user}/edit'
 */
...
edit.definition = {
    methods: ["get","head"],
    url: '/secretaria/users/{user}/edit',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\Secretaria\UserController::update
 * @see app/Http/Controllers/Secretaria/UserController.php:125
 * @route '/secretaria/users/{user}'
 */
...
/**
* @see \App\Http\Controllers\Secretaria\UserController::destroy
 * @see app/Http/Controllers/Secretaria/UserController.php:181
 * @route '/secretaria/users/{user}'
 */
