 ...
 * @see app/Http/Controllers/Professor/LessonPlanController.php:106
 * @route '/professor/planning/{planning}'
 */
 ...
 * @see app/Http/Controllers/Professor/LessonPlanController.php:136
 * @route '/professor/planning/{planning}'
 */
 ...
 * @see app/Http/Controllers/Professor/LessonPlanController.php:126
...
const LessonPlanController = { index, create, store, show, edit, update, destroy, submit }
