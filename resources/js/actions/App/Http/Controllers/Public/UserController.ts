...
/**
* @see \App\Http\Controllers\Public\UserController::index
 * @see app/Http/Controllers/Public/UserController.php:22
 * @route '/public/users'
 */
...
/**
* @see \App\Http\Controllers\Public\UserController::edit
 * @see app/Http/Controllers/Public/UserController.php:41
 * @route '/public/users/{user}/edit'
 */
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\Public\UserController::update
 * @see app/Http/Controllers/Public/UserController.php:58
 * @route '/public/users/{user}'
 */
...
const UserController = { index, edit, update }
