    ...
    return (
        <div className="min-h-screen bg-gray-100 p-8">
            ...
            <div className="max-w-4xl mx-auto">
                <Link href="/public/users" className="flex items-center text-gray-600 mb-4 hover:text-gray-900">
                    <ArrowLeft className="h-4 w-4 mr-1" /> Voltar para lista
                </Link>

                <div className="bg-white rounded-xl shadow-md p-6">
                    <h2 className="mb-6 text-xl font-semibold text-gray-800">Editar Usuário (Público)</h2>
                        ...
                        <Tabs defaultValue="general" className="w-full">
                            ...
                            <TabsContent value="allocations" className="space-y-6">
                                <div className="p-4 border rounded-lg bg-gray-50 space-y-4">
                                    <h3 className="font-semibold text-sm uppercase text-gray-500 mb-2">Vincular turmas e disciplinas</h3>
                                ...
                                <div className="space-y-4">
                                    <h3 className="font-semibold text-sm uppercase text-gray-500">Turmas do Professor</h3>
