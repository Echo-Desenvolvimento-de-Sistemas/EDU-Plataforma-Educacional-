...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Notas e Boletins', href: '/admin/student-grades' },
...
export default function Entry({ classes, gradingPeriods }: Props) {
    ...
    const fetchData = async () => {
        setLoadingData(true);
        try {
            const response = await axios.get(`/admin/student-grades/${selectedClassId}/grades-api?grading_period_id=${selectedPeriodId}&subject_id=${selectedSubjectId}`);
    ...
    const handleSave = async () => {
        ...
        try {
            await axios.post(`/admin/student-grades/${selectedClassId}/grades-batch`, {
    ...
    const handleDeleteAssessment = async (assessmentId: number) => {
        ...
        try {
            await axios.delete(`/admin/student-grades/${selectedClassId}/assessments/${assessmentId}`);
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Lançar Notas - Administrador" />
            ...
            <div className="flex flex-col gap-6 p-4 max-w-[95%] mx-auto w-full pb-20">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold tracking-tight">Lançamento de Notas (Administrador)</h1>
                ...
                <DialogContent>
                    ...
                    <DialogFooter>
                        ...
                        <Button onClick={async () => {
                            ...
                            setIsCreating(true);
                            try {
                                const response = await axios.post(`/admin/student-grades/${selectedClassId}/assessments`, {
                                    ...createForm,
