...
class DemoDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $subjects = [];
        foreach (['Matemática', 'Português', 'História', 'Geografia', 'Ciências', 'Inglês'] as $sName) {
            $subjects[] = Subject::firstOrCreate(
                ['name' => $sName],
                ['code' => mb_strtoupper(mb_substr($sName, 0, 3))]
            );
        }
        ...
        foreach ($grades as $grade) {
            $class = ClassRoom::firstOrCreate(
                ['name' => "Turma " . mb_substr($grade->name, 0, 1) . "01"],
                [
                    'grade_id' => $grade->id,
            ...
            // 4. Class Schedules (Horários de Aula)
        ...
        SchoolEvent::create([
            ...
            'type' => 'meeting',
            'start_date' => '2024-03-10 19:00:00',
